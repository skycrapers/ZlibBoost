"""Delay timing simulation executor."""
...
class DelaySimulationExecutor(BaseSimulationExecutor):
    """Executor for delay/transition characterization decks."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._parser_registry = parser_registry or MeasurementParserRegistry(
            [DelaySpectreParser(), DelayHspiceParser()]
        )
    ...
    def _resolve_engine_workdir(
        ...
        sim_type = metadata.get("sim_type", "delay")
    ...
    def _write_artifacts(
        ...
        artifact_path = sim_dir / f"{arc_id}_delay.json"
